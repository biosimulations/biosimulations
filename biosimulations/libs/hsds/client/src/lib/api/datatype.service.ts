...
export class DatatypeService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datatypesIdAclsGet(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<AxiosResponse<InlineResponse20019>>;
    public datatypesIdAclsGet(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<any> {
        ...
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling datatypesIdAclsGet.');
        }
        ...
        return this.httpClient.get<InlineResponse20019>(`${this.basePath}/datatypes/${encodeURIComponent(String(id))}/acls`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datatypesIdDelete(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<AxiosResponse<InlineResponse20013>>;
    public datatypesIdDelete(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<any> {
        ...
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling datatypesIdDelete.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datatypesIdGet(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<AxiosResponse<InlineResponse20012>>;
    public datatypesIdGet(id: string, accept: 'application/json', domain?: string, authorization?: string, ): Observable<any> {
        ...
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling datatypesIdGet.');
        }
