import { Ontologies, FunderRegistryTerm, OntologyInfo } from '@biosimulations/datamodel/common';
...
export const funderRegistryInfo: OntologyInfo = {
  ...
  description: 'The Funder Registry and associated funding metadata allows everyone to have transparency into research funding and its outcomes. It’s an open and unique registry of persistent identifiers for grant-giving organizations around the world.',
  bioportalId: null,
  olsId: null,
  version: null,
