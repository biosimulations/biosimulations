...
export class SimulatorService {
  getAll(): Observable<any[]> {
    return this.http.get<any[]>('/simulators-api');
  }
  getLatest(): Observable<any[]> {
    return this.http.get<any[]>('/simulators-api/latest');
  }
  constructor(private http: HttpClient) {}
  static data: Observable<Simulator[]> = of([
    {
      id: 'copasi',
      name: 'COPASI',
      description:
        'COPASI is a C++-based software application for the simulation and analysis of biochemical networks and their dynamics.',
    ...
    },
    {
      ...
      name: 'VCell',
      description:
        'VCell (Virtual Cell) is a comprehensive platform for modeling cell biological systems that is built on a central database and disseminated as a standalone application',
          ...
          characteristics: [
            {
              ...
              url:
                'https://www.ebi.ac.uk/ols/ontologies/kisao/terms?iri=http%3A%2F%2Fwww.biomodels.net%2Fkisao%2FKISAO%23KISAO_0000035',
            },
            {
              ontology: 'KISAO',
              id: '0000288',
              ...
              url:
                'https://www.ebi.ac.uk/ols/ontologies/kisao/terms?iri=http%3A%2F%2Fwww.biomodels.net%2Fkisao%2FKISAO%23KISAO_0000288',
            },
            {
              ontology: 'KISAO',
              id: '0000280',
              ...
              url:
                'https://www.ebi.ac.uk/ols/ontologies/kisao/terms?iri=http%3A%2F%2Fwww.biomodels.net%2Fkisao%2FKISAO%23KISAO_0000280',
            },
          ],
          modelingFrameworks: [{ ontology: 'SBO', id: '0000293' }],
          modelFormats: [{ ontology: 'EDAM', id: 'format_2585' }],
        ...
        citations: [
          {
            ...
            authors:
              'Kiri Choi, J. Kyle Medley, Matthias König, Kaylene Stocking, Lucian Smith, Stanley Gua & Herbert M. Sauro',
            journal: 'Biosystems',
            volume: 171,
            pages: '74-79',
            year: 2018,
    ...
    },
    {
      ...
      name: 'BioNetGen',
      description:
        'BioNetGen is an open-source software package for rule-based modeling of complex biochemical systems.',
