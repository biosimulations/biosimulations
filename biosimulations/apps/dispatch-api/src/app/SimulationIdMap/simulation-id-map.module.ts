...
import { SimulationIdMap, SimulationIdMapSchema } from './schemas/simulation-id-map.schema';

@Module({
  imports: [MongooseModule.forFeature([{ name: SimulationIdMap.name, schema: SimulationIdMapSchema }])],
