...
export class SimulationStatusService {
  ...
  static getSimulationStatusOrder(status: SimulationStatus): number {
    switch (status) {
      case SimulationStatus.succeeded: return 0;
      case SimulationStatus.running: return 1;
      case SimulationStatus.started: return 2;
      case SimulationStatus.queued: return 3;
      case SimulationStatus.failed: return 4;
    }
    return NaN;
  }

  static getSimulationStatusMessage(status: SimulationStatus, upperCaseFirstLetter=false): string {
