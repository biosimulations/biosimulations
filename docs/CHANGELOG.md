...
* added api target ([4feafcb](https://github.com/biosimulations/biosimulations/commit/4feafcb359cd578e4af9f2cbce0b6aa5d0c13fc5))
* added catch clause ([4e2b106](https://github.com/biosimulations/biosimulations/commit/4e2b1067d68ca99f9633e0123bb623d85c5ccb32))
* added catch to nav ([5215b42](https://github.com/biosimulations/biosimulations/commit/5215b429ec44f67acfacb863764c88c9bdf78071))
* added commonjs mapping ([86a8c23](https://github.com/biosimulations/biosimulations/commit/86a8c2390cdb5937cf95612a404d5ff75d4d9443))
* added configService provider to shared status service test bed ([c523cc8](https://github.com/biosimulations/biosimulations/commit/c523cc87f4d77d3bcba4bf7eab81645571e5a5d9))
* added dispatch spec handler ([b00712d](https://github.com/biosimulations/biosimulations/commit/b00712d3379d44fd9c8ddbd53007a632b55fb055))
* added download ([1a0cf0e](https://github.com/biosimulations/biosimulations/commit/1a0cf0ed823affc835ec9b1f054b727b5934c9ab))
* added enumeration indices to service implementation in dispatch ([fed64e0](https://github.com/biosimulations/biosimulations/commit/fed64e010c821f4b1fa6bd8cff85e5d536204b3b))
* added esm use ([22c47a9](https://github.com/biosimulations/biosimulations/commit/22c47a9e7f7e82d004c9165bba36e9fcce471d10))
* added esmodule interop to services ts spec config ([3a80fde](https://github.com/biosimulations/biosimulations/commit/3a80fde53dcdf71733f1522e65bddb32e433dec6))
* added formatted simulation to spec ([6dacfa5](https://github.com/biosimulations/biosimulations/commit/6dacfa5bccc66576e84da1fb6d5b62a93a185f99))
* added handler specs ([b7b76a2](https://github.com/biosimulations/biosimulations/commit/b7b76a270306078dccd895a4ff98579cb447d590))
* added http handler ([caca0d0](https://github.com/biosimulations/biosimulations/commit/caca0d04f6c856ba3d55f27f6bd8182fb612b9fc))
* added hydration to handler ([b8aa6ae](https://github.com/biosimulations/biosimulations/commit/b8aa6aeb90eb7b5a5cf2fa830894da255cc89556))
* added jest config ([a9d35a6](https://github.com/biosimulations/biosimulations/commit/a9d35a61a9cf8fd45e99cd5d90026b7c5604d35f))
* added metadata handler ([cf1201e](https://github.com/biosimulations/biosimulations/commit/cf1201e7eb1a0ee41190f32b68e2fad008ffd63d))
* added onInit trigger for utc params ([2cd07af](https://github.com/biosimulations/biosimulations/commit/2cd07af43fc1887263d9c55949489d987852303c))
* added provider for shared service spec ([b3ccd36](https://github.com/biosimulations/biosimulations/commit/b3ccd36ebebb3ce5fe805c304eee9259445562f8))
* added refactor ([cd3528b](https://github.com/biosimulations/biosimulations/commit/cd3528b843b24162896b510025978f41d5a93acb))
* added scope to eslint ([273da8b](https://github.com/biosimulations/biosimulations/commit/273da8b5883d41c5c982c016937c59700af8c494))
* added semantic commits to gitignore ([6cd4d15](https://github.com/biosimulations/biosimulations/commit/6cd4d1518a590e56ba38c48db72a4568adf9b252))
* added setter to constructor ([f938bc0](https://github.com/biosimulations/biosimulations/commit/f938bc0ce51b0422e7ad24c140db33f874389bdb))
* added transform ignore ([cbef444](https://github.com/biosimulations/biosimulations/commit/cbef44418ee56751b42e226e5dceb75dc7f49414))
* added transform ignore to api spec ([785851a](https://github.com/biosimulations/biosimulations/commit/785851afb8ef8475072f31656ebcffbd5a467a58))
* adjusted handler ([ca5090f](https://github.com/biosimulations/biosimulations/commit/ca5090f4a51efc98a7e48d05b59e4d6d4fd6962c))
* adjusted sim run controller spec ([f053bef](https://github.com/biosimulations/biosimulations/commit/f053befceded3bd2a0d340c94cd74e37167c1fac))
* adjusted ts jest in preset ([e7b696a](https://github.com/biosimulations/biosimulations/commit/e7b696af15596c04720d7d201cc65e6df4902c85))
* auto stash before merge of "add-editor" and "origin/add-editor" ([237a983](https://github.com/biosimulations/biosimulations/commit/237a983f2e829989d46cddcbe79ab0bcde9c7afa))
* changed namespace for shared service test ([8674abe](https://github.com/biosimulations/biosimulations/commit/8674abeb2887d912fb2a242f7961d60da1e21084))
* created test-setup for jest ([620c905](https://github.com/biosimulations/biosimulations/commit/620c905ae5be5858bb82d37753c35c0700426e4d))
* imported matcard module in test for platform overview ([d1bbfaf](https://github.com/biosimulations/biosimulations/commit/d1bbfafc89fa1db290057887f3247749aa945b62))
* refactor ([cd3c726](https://github.com/biosimulations/biosimulations/commit/cd3c72644358c7ce5423e187b07b3f07e340f68d))
* refactored shared sim service uses to absolute imports ([e89d7f7](https://github.com/biosimulations/biosimulations/commit/e89d7f7be39649a30455c0a6f93e7a5c5dd69817))
* rem types from api tsconfig ([21b8ee9](https://github.com/biosimulations/biosimulations/commit/21b8ee940e9f32f10807962f1399e9e96cd29775))
* removed exports from shared ([b33b85f](https://github.com/biosimulations/biosimulations/commit/b33b85f0471ee4cc05cc93f35055e91120fc2c6e))
* removed ext from preset jest ([d5e2188](https://github.com/biosimulations/biosimulations/commit/d5e2188b5e05d99cfeb1ecd8ccb63c7001b2d2d9))
* removed hidden simulator card added rerun handler and cleaned load ([8a3afad](https://github.com/biosimulations/biosimulations/commit/8a3afad76316f8d107e198d329595a745f64b6a4))
* removed log and added config service provider to sim spec ([b39c72b](https://github.com/biosimulations/biosimulations/commit/b39c72b09a3a66c7c193f66515456bc345eaa892))
* removed module from tsconfigs ([02ee0b5](https://github.com/biosimulations/biosimulations/commit/02ee0b525439398c8968b4a5cdf32365327dbeb6))
* removed null return ([6ab97d8](https://github.com/biosimulations/biosimulations/commit/6ab97d8932d891d2ed21c78fa1723af4a4dd3e9d))
* removed optional operator in component dec ([bcd19e4](https://github.com/biosimulations/biosimulations/commit/bcd19e4686d5fc38e959f51574404cd7f43239a5))
* removed self provider from shared spec ([f485d73](https://github.com/biosimulations/biosimulations/commit/f485d731f78b04c19219a9f7c627796e743549bb))
* removed shared ui content ([9799e29](https://github.com/biosimulations/biosimulations/commit/9799e29d27719fbafa0fde9261662ddfa31b48a0))
* removed unused on init ([de64a45](https://github.com/biosimulations/biosimulations/commit/de64a45372467b45f32ec06160daf23c9cf0d5fe))
* revert change ([6f373e8](https://github.com/biosimulations/biosimulations/commit/6f373e814ed432d4114c0c59803c86f317103328))
* revert poetry config ([163daac](https://github.com/biosimulations/biosimulations/commit/163daac69e4a49f2f081ef84bb1e3eaf53d508b3))
* revert pyproject in simdata ([8360499](https://github.com/biosimulations/biosimulations/commit/836049914a177c94cdcbf810bf4dd5f1c7f72ce3))
* revert semantic commit ([69ab7e9](https://github.com/biosimulations/biosimulations/commit/69ab7e93e9cc6bdfc127ed264af7b150787bc574))
* revert to working specs ([5833fef](https://github.com/biosimulations/biosimulations/commit/5833fef81fd9f3b324d1f1a12cb79a62fa9b7aee))
* revert tsconfig and absolute import ([e2996ca](https://github.com/biosimulations/biosimulations/commit/e2996cabea7c17df77c7af401af6a7765379a0f8))
* revert workflow ([11b970c](https://github.com/biosimulations/biosimulations/commit/11b970c9f54021c4411c0bf88bcacaa2dd4b26d8))
* run app spec ([0299db7](https://github.com/biosimulations/biosimulations/commit/0299db7ee22dd4d997564c8c951aa03b972c4f9d))
* sed specific implementation ([293090d](https://github.com/biosimulations/biosimulations/commit/293090d73cb34311953bb3ee35feb0173e73ca36))
* shortcut route ([eefc276](https://github.com/biosimulations/biosimulations/commit/eefc276bdfc72feace323edea6fc60fdc32d1704))
* ts config ([5ea692d](https://github.com/biosimulations/biosimulations/commit/5ea692d8ee6bed8e6bada69783ed3a9eed5b7581))
* updated allowed commit temp ([5fc3092](https://github.com/biosimulations/biosimulations/commit/5fc3092fff0c5cae6157eb3e14818594687c7bb5))
* updated config ([e9f58ce](https://github.com/biosimulations/biosimulations/commit/e9f58ce2e25b61545eb4a8368f81893af226d3ff))
* updated css and array instance name for builder ([ad61109](https://github.com/biosimulations/biosimulations/commit/ad61109bf41e6f671e608f7f08e29fed593f73de))
* updated es module target for api spec ([f4cedc3](https://github.com/biosimulations/biosimulations/commit/f4cedc369ae22dc5eb4e370abf95847eb276dfb4))
* updated files for failing tests ([73c580b](https://github.com/biosimulations/biosimulations/commit/73c580b891d64981d31cdd4635aaab9530908718))
* updated files subscription for sbml setter ([247b172](https://github.com/biosimulations/biosimulations/commit/247b172e3b008cf74a71cdf3f4777e76d1e73bde))
* updated global jest and api config ([1e21516](https://github.com/biosimulations/biosimulations/commit/1e21516b351ab821bfc8ee2551e742bed7be986e))
* updated metadata addition to archive creation ([28e1f6a](https://github.com/biosimulations/biosimulations/commit/28e1f6ad5f60b4b077350e533de802433f37b98b))
* updated nx cloud in package json ([b7abbca](https://github.com/biosimulations/biosimulations/commit/b7abbca4e226572632f9d42126e1d3df89346076))
* updated parameters form interface for n string params ([420d571](https://github.com/biosimulations/biosimulations/commit/420d5712ae795b55f61d1bf411b2944352a0bc2c))
* updated poetry config to include flask option in connexion ([0895df2](https://github.com/biosimulations/biosimulations/commit/0895df2a3eb3ec985de67dabc197019901c4566e))
* updated project introspection form params ([c55a47a](https://github.com/biosimulations/biosimulations/commit/c55a47ad205a07944d5e80b81cdf19b8f01c496a))
* updated shared service ([f8d084e](https://github.com/biosimulations/biosimulations/commit/f8d084e85e8fd2de4d727facdb5456a5cb34c800))
* updated shared service spec for storage and other injectables ([7516e66](https://github.com/biosimulations/biosimulations/commit/7516e66d997e377aca559f4f9d90b041493fc29c))
* updated shared service tsconfig to include es2020 ([2ae1d10](https://github.com/biosimulations/biosimulations/commit/2ae1d10080ef3e74ce786b326f3ad240f6751dab))
* updated simulation shared service to include proper providers ([f4d607d](https://github.com/biosimulations/biosimulations/commit/f4d607d80f0da854ac1fe6fd7017a2563b3c1a79))
* updated spec file for shared sim service ([c63f52f](https://github.com/biosimulations/biosimulations/commit/c63f52f79e6ebe44d5afedc2b8270717dd65e603))
* updated ts spec config to include ecma script module ([c3b12bb](https://github.com/biosimulations/biosimulations/commit/c3b12bb1d6059a4b3b026279f8bd16f68218a27d))


### Features

* added activated route to create project ([f3ca9a3](https://github.com/biosimulations/biosimulations/commit/f3ca9a3c2192e7f706e1ee0db29c92d5d775441e))
* added biosimulators-utils to poetry config ([b116d41](https://github.com/biosimulations/biosimulations/commit/b116d41325c7412580fc3ec842fa167bb0b03d70))
* added changes access ([b581906](https://github.com/biosimulations/biosimulations/commit/b581906f6b4135feedebe1489bb2b12b645af8f0))
* added correct angular template getter data to html and kept mock ([dc562e8](https://github.com/biosimulations/biosimulations/commit/dc562e8cc412245b4daffd9e07f82367c6261f5b))
* added form builder implementation in dispatch ([aa1e478](https://github.com/biosimulations/biosimulations/commit/aa1e478f409cb0db9e7a84ebd819b40b9201f5ea))
* added image files to project ([d70d680](https://github.com/biosimulations/biosimulations/commit/d70d6804e8bbce38ef20b1f2a844940791ce863b))
* added non sbml and supported handler ([f4ae688](https://github.com/biosimulations/biosimulations/commit/f4ae688953318bf7ba472c9c686c22aeb8aee8f7))
* added observable to rerun ([464be7b](https://github.com/biosimulations/biosimulations/commit/464be7bb0b224b72710433fded286f3448f17714))
* added parameter change form on archive submit ([f7b301a](https://github.com/biosimulations/biosimulations/commit/f7b301ac4d960061e415ee2de0d042cd66039b0c))
* added post sed doc method ([a0712ce](https://github.com/biosimulations/biosimulations/commit/a0712ce8387adeb2afb6de85ba220c02f4ff97d8))
* added project metadata file ([37b9b59](https://github.com/biosimulations/biosimulations/commit/37b9b597f1d18e6e8442f844cc7c18ecf772af62))
* added service method for platform ([e6aef1e](https://github.com/biosimulations/biosimulations/commit/e6aef1ebd954636e3ff37582460c349e26414fc5))
* added shared form ([b04abb2](https://github.com/biosimulations/biosimulations/commit/b04abb2e40406590fa282ad4fb5875fe764a8b8a))
* added sim and model form data interfaces in dispatch ([658a207](https://github.com/biosimulations/biosimulations/commit/658a2075551e5661640e9da3b65796f1bdcb0270))
* added simulation service method ([016ddfe](https://github.com/biosimulations/biosimulations/commit/016ddfea7ccec578cd43e87e5137d6e437c78ba8))
* copied content for shared ([8aa5213](https://github.com/biosimulations/biosimulations/commit/8aa521388a3c52b1edba64ad8885d031a0ba2524))
* copied content from model changes ([da069bb](https://github.com/biosimulations/biosimulations/commit/da069bbe5b420601f8e78af17f3b6e68aaa3cd1e))
* copied full service from service ([6c24041](https://github.com/biosimulations/biosimulations/commit/6c24041fe16835284af877fc4639e1aab0847304))
* correct implementation of service ([0f247c5](https://github.com/biosimulations/biosimulations/commit/0f247c5d4eb7dc7466bdb3928f20e2c83865d737))
* created and implemented rerun custom overview btn in platform ([c401b0d](https://github.com/biosimulations/biosimulations/commit/c401b0d81daabad7a1054dbaeb687eb0e8ec9859))
* created shared service file and updated shared datamodel ([1c29df2](https://github.com/biosimulations/biosimulations/commit/1c29df2770a579d2c4baf1459c5d63056ffd380d))
* extracted full params ([8d40ad2](https://github.com/biosimulations/biosimulations/commit/8d40ad27c97a504569e5320295bbb7d751f51a10))
* ported utc params ([73b3763](https://github.com/biosimulations/biosimulations/commit/73b37631192e5d8590cca143609a3eb267db005a))
* provided url transform to reroute dispatch runs to biosimulations ([f0a24bb](https://github.com/biosimulations/biosimulations/commit/f0a24bb500779cebb6d503cbb644e54677c77161))
* reformatted code and implemented third solution type to dispatch ([3e167bb](https://github.com/biosimulations/biosimulations/commit/3e167bbf7eb4b2a2b0095d58dce03bebaefe9029))
* request now working ([fc5190f](https://github.com/biosimulations/biosimulations/commit/fc5190f194709698bf414de7d9ca80815fc0b349))
* update setters and add changes getter ([1d645ec](https://github.com/biosimulations/biosimulations/commit/1d645ece08cf7944d735b0b9c9e6987d8e2d5c9e))
* updated click handler savepoint ([2846901](https://github.com/biosimulations/biosimulations/commit/28469017ca64d2099a7637d209253cb6d3651835))
* updated introspection ([5215b73](https://github.com/biosimulations/biosimulations/commit/5215b73744b4559d429fe891e828abf2cccc4462))
* updated project metadata in view to handle images ([79bb1af](https://github.com/biosimulations/biosimulations/commit/79bb1af31c95c167be90d08ae837267ac4bba193))
* updated sim service with shared ([f137f83](https://github.com/biosimulations/biosimulations/commit/f137f8398031820869d3ef344566d1fe69f83fed))
* updated utc params ([b5962b5](https://github.com/biosimulations/biosimulations/commit/b5962b53a6d54bc5ff82b807e7a3ca22c4353810))
