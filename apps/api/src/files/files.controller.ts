...
import { ProjectFile, SubmitProjectFile, SubmitProjectFileInput } from '@biosimulations/datamodel/api';
import {
  Controller,
  Post,
  Get,
...
export class FilesController {
  ...
  */
  ...
  public async createFiles(@Body() files: SubmitProjectFileInput): Promise<void> {
