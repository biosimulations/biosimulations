  ...
  imports: [
    ...
    MongooseModule.forFeature([
      { name: SpecificationsModel.name, schema: SpecificationsModelSchema },
      {
        ...
        discriminators: [
          {
            name: SedModelAttributeChange.name,
            schema: SedModelAttributeChangeSchema,
          },
        ],
      },
      {
        ...
        discriminators: [
          {
            name: SedOneStepSimulation.name,
            schema: SedOneStepSimulationSchema,
          },
          {
            name: SedSteadyStateSimulation.name,
            schema: SedSteadyStateSimulationSchema,
          },
          {
            name: SedUniformTimeCourseSimulation.name,
            schema: SedUniformTimeCourseSimulationSchema,
          },
        ],
      },
      {
