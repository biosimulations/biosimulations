  ...
  public async process(job: Job): Promise<void> {
    ...
    const manifestJob = {
      ...
      data: {
        ...
        validator: 'https://biosimulations.org/utils/validate-project',
    ...
    const sedmljob = {
      ...
      data: {
        ...
        validator: 'https://biosimulations.org/utils/validate-simulation',
    ...
    const metadataJob = {
      ...
      data: {
        ...
        validator: 'https://biosimulations.org/utils/validate-metadata',
