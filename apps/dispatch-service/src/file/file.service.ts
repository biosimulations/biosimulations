...
export class FileService {
  ...
  public processFiles(
    id: string,
    manifestContent: CombineArchiveManifestContent[],
  ...
  public postFiles(
    id: string,
    manifestContent: ProjectFileInput[],
  ): Observable<ProjectFile[]> {
