...
@Component({
  ...
  templateUrl: './chart-types-grid.component.html',
  styleUrls: ['./chart-types-grid.component.sass'],
})
export class ChartTypesGridComponent implements OnInit {
  ...
  set owner(value: string) {
    this._owner = value;
    this.rowData = this.chartTypeService.list(null, value);
  }
  ...
  ngOnInit() {
    ...
    this.rowData = this.chartTypeService.list(null, this._owner);
  }
