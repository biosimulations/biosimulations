      ...
      const buttons: NavItem[] = [
        {
          ...
          displayUser: (this.model.access === AccessLevel.public ? NavItemDisplayLevel.never : NavItemDisplayLevel.user),
        },
        {
          iconType: 'fas',
          icon: 'trash-alt',
          ...
          display: (this.model.access === AccessLevel.public ? NavItemDisplayLevel.never : NavItemDisplayLevel.always),
        },
        {
          iconType: 'fas',
          icon: 'list',
