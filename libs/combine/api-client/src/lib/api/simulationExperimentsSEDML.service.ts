...
@Injectable()
export class SimulationExperimentsSEDMLService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public srcHandlersSedMlGetParametersVariablesForSimulationHandler(modelLanguage: string, simulationType: string, modelingFramework: string, simulationAlgorithm: string, modelFile?: Blob, modelUrl?: string, ): Observable<AxiosResponse<SedDocument>>;
    public srcHandlersSedMlGetParametersVariablesForSimulationHandler(modelLanguage: string, simulationType: string, modelingFramework: string, simulationAlgorithm: string, modelFile?: Blob, modelUrl?: string, ): Observable<any> {

        if (modelLanguage === null || modelLanguage === undefined) {
            throw new Error('Required parameter modelLanguage was null or undefined when calling srcHandlersSedMlGetParametersVariablesForSimulationHandler.');
        }

        if (simulationType === null || simulationType === undefined) {
            throw new Error('Required parameter simulationType was null or undefined when calling srcHandlersSedMlGetParametersVariablesForSimulationHandler.');
        }

        if (modelingFramework === null || modelingFramework === undefined) {
            throw new Error('Required parameter modelingFramework was null or undefined when calling srcHandlersSedMlGetParametersVariablesForSimulationHandler.');
        }

        if (simulationAlgorithm === null || simulationAlgorithm === undefined) {
            throw new Error('Required parameter simulationAlgorithm was null or undefined when calling srcHandlersSedMlGetParametersVariablesForSimulationHandler.');
        }
        ...
        return this.httpClient.post<SedDocument>(`${this.basePath}/sed-ml/get-parameters-variables-for-simulation`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
    ...
    public srcHandlersSedMlValidateHandler(file?: Blob, url?: string, ): Observable<any> {
        ...
        return this.httpClient.post<ValidationReport>(`${this.basePath}/sed-ml/validate`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
