...
export class SimulationExecutionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public srcHandlersRunRunHandler(simulator: string, type: string, archiveUrl?: string, archiveFile?: Blob, environment?: Environment, ): Observable<AxiosResponse<SimulationRunResults>>;
    public srcHandlersRunRunHandler(simulator: string, type: string, archiveUrl?: string, archiveFile?: Blob, environment?: Environment, ): Observable<any> {
        ...
        return this.httpClient.post<SimulationRunResults>(`${this.basePath}/run/run`,
