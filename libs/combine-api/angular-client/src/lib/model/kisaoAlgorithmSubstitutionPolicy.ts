...
export interface KisaoAlgorithmSubstitutionPolicy {
   ...
   * Id of the policy
   */
  id: KisaoAlgorithmSubstitutionPolicyIdEnum;
  /**
   ...
   * Name of the policy
   */
  name: KisaoAlgorithmSubstitutionPolicyNameEnum;
  /**
   * Type
   */
  _type: KisaoAlgorithmSubstitutionPolicyTypeEnum;
}
export enum KisaoAlgorithmSubstitutionPolicyIdEnum {
  NONE = 'NONE',
...
export enum KisaoAlgorithmSubstitutionPolicyNameEnum {
  None = 'None',
