...
export interface SedUniformRange {
  ...
  /**
   * Number of steps, equal to the 1 less than the number of iterations.
   */
  numberOfSteps: number;
  /**
   * Type
   */
  type: SedUniformRangeTypeEnum;
}
export enum SedUniformRangeTypeEnum {
