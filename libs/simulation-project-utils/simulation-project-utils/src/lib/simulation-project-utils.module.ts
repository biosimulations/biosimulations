...
// Define the routes for the form steps
const createProjectRoutes: Routes = [
  ...
  { path: 'create-project/model-variables', component: ModelVariablesComponent },
];
...
@NgModule({
  ...
  exports: [ModelChangesComponent, CreateProjectComponent],
})
