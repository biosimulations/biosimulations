...
export const BIOSIMULATIONS_FORMATS: EdamTerm[] = biosimulationsFormatsJson
  .map((jsonFormat: any, iFormat: number): EdamTerm => {
    ...
    if (isPropsedTerm) {
      ...
      format.url = 'https://www.ebi.ac.uk/ols/ontologies/edam/terms?iri=' +
